...
description: "Choose and run a production-quality PPT workflow based on editability, delivery format, and reference assets. Use for creating or planning a client-ready deck; not for a simple slide text edit."
---
...
- `baoyu-slide-deck`: image-first knowledge decks when later editing is unlikely.
- `baoyu-design`: HTML-first custom visual design or prototype-style slides.
